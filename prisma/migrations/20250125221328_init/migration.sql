...
CREATE TABLE "schedule" (
    ...
    "timeStart" TIMETZ NOT NULL,
    "timeEnd" TIMETZ NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "schedule_teacher_id_dayOfWeek_lesson_class_subclass_timeSta_key" ON "schedule"("teacher_id", "dayOfWeek", "lesson", "class", "subclass", "timeStart", "timeEnd");
